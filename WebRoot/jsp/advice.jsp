...
.ov1{top:731px;left:945px;}
.ov2{top:730px;left:945px;border-bottom-color:#D6D6D6;}
...
<div class="so">
 ...
 <p>&nbsp;</p>
            <p align="center">*昵　　称：
              <input name="textfield3" type="text" class="textfield2"  />
            </p>
            
            <p align="center">联系 电话：
              <input name="textfield4" type="text" class="textfield2"  />
            </p>
            
            <p align="center">*电子邮件：
              <input name="textfield5" type="text" class="textfield2"  />
            </p>
          
            <p align="center">*标　　题：
              <input name="textfield6" type="text" class="textfield2"  />
            </p>
           
            <p align="center">
              <label>*详细内容：
                <textarea name="详细内容" cols="40" rows="5" id="详细内容"></textarea>
              </label>
            </p>
